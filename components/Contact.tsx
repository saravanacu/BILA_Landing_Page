...
const Contact = () => {
  return (
    <section className="w-full bg-white dark:bg-background-dark py-20 scroll-mt-20" id="contact">
      <div className="max-w-7xl mx-auto px-4 flex flex-col items-center text-center gap-12">
        <div className="max-w-3xl">
          <h2 className="text-secondary dark:text-white text-3xl md:text-4xl font-bold mb-4">
            Contact Us
          </h2>
